    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.tvCans = convertView
                        .findViewById(R.id.tvCorrectAns);
                viewHolder.tvYouans = convertView
            ...
            viewHolder.tvCans.setText("Đáp án đúng: " + originalValues.get(position).get(KEY_CANS)
                    .toString());
            viewHolder.tvYouans.setText("Câu trả lời của bạn: " + originalValues.get(position)
