...
public class SettingsPage extends AppCompatActivity {
    ...
    public void setup() {
        ...
        backBtn = findViewById(R.id.settingsCancel);
        forwardButton = findViewById(R.id.settingsStart);
        title1 = findViewById(R.id.additionsLbl);
        title2 = findViewById(R.id.subtractionLbl);
        title3 = findViewById(R.id.multiplicationsLbl);
        title4 = findViewById(R.id.divisionsLbl);

        Button cancelBtn = findViewById(R.id.settingsCancel);
        cancelBtn.setScaleX((float) (cancelBtn.getScaleX() * 0.75));

        Button startBtn = findViewById(R.id.settingsStart);
    ...
    public void toDifficultyPage(View v) {
        ...
        if (temp > 0) { // proceed
            ...
            alertDialog.setTitle("KHÔNG CÓ LOẠI TRÒ CHƠI NÀO ĐANG ĐƯỢC CHỌN");
            alertDialog.setMessage("Vui lòng chọn một loại trò chơi");
